...
describe("IntentComposer", () => {
  it("reviews the exact multi-step yield goal as one registered composition", async () => {
    const composed = {
  ...
  it("signs the reviewed composition policy and posts its exact commitment", async () => {
    const composed = {
      kind: "composed", inputToken: INTENT_ASSETS[0]!.address, amount: "1",
      capabilityIds: ["aave-v3.supply", "curve-stableswap-ng.exact-input",
        "uniswap-v3.exact-input"],
