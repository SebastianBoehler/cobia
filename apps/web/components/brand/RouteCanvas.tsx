export function RouteCanvas() {
  return (
    <div className="route-canvas" role="img" aria-label="A pinned Aave and Uniswap snapshot leads to independently verified solver routes">
      ...
      <div className="route-canvas__label route-canvas__label--quote"><span>03</span> Solver routes</div>
