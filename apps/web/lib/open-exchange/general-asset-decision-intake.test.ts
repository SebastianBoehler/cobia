...
const program = GeneralAssetProgramV1Schema.parse({
  ...
  stages: [{ stageId: hash("8"), index: 0, chainId: 1, predecessorStageId: null,
    calls: [{ adapter: { id: "okx.market", version: 1 }, target, targetRuntimeCodeHash: hash("5"),
      calldata: "0x12345678", nativeValueAtomic: "0", gasLimit: 300_000, approvals: [] }],
    ...
    outputs: [{ token: outputToken, minimumIncreaseAtomic: "90",
      identityEvidenceHash: commitment(outputIdentity) }],
