...
export const COBIA_EXECUTOR_V4_ABI = parseAbi([
  "struct ApprovalV4 { address token; uint128 amount; }",
  ...
  "function execute(ExecutionProgramV4 program, VerifierAuthorizationV4 authorization, bytes signature) payable",
]);
